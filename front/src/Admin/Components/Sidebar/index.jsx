...
import { HomeIcon, CubeIcon, UsersIcon, ClipboardDocumentListIcon, Bars3Icon, XMarkIcon } from "@heroicons/react/24/solid";
...
const Sidebar = () => {
    ...
    return (
        <>
            ...
            <button
                className="absolute top-4 left-4 z-50 p-2 bg-indigo-500 text-white rounded-lg md:hidden"
            ...
            {/* Sidebar */}
            <aside
                className={`fixed inset-y-0 left-0 bg-indigo-700 text-white w-64 p-6 transition-transform duration-200 ${isSidebarOpen ? "translate-x-0" : "-translate-x-64"
